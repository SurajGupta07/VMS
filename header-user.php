...
<head>
  ...
  <title><?php echo ucwords('VMS'); ?> | <?php echo (isset($x->TableTitle) ? $x->TableTitle : ''); ?></title>
  <!-- Bootstrap core CSS -->
  ...
  <div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.php"><span class="fa fa-home">VMS</span></a>
      </div>
  ...
  <div id="page-wrapper">
    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <h1><small> Visitor Management System</small></h1>
        <div>
            <img src="ait.png" alt="myPic" />
            <style>
img {
  float: right;
  width:15%;
  height:15%;
        ...
        <ol class="breadcrumb">
          <li><a href="index.php" style="text-decoration: none;"><i class="icon-dashboard"></i><strong>VMS</strong></a></li>
